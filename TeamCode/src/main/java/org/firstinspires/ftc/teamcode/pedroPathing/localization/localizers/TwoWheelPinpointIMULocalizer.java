...
public class TwoWheelPinpointIMULocalizer extends Localizer {
    ...
    public TwoWheelPinpointIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "backRightMotor")); // port 3
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "strafeEncoder")); // port 0
