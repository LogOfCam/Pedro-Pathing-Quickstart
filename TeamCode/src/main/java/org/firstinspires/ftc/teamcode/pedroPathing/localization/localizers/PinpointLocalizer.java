...
public class PinpointLocalizer extends Localizer {
    ...
    public PinpointLocalizer(HardwareMap map, Pose setStartPose){
        ...
        odo.setOffsets(120.000014, 135.999982); //these are tuned for 3110-0002-0001 Product Insight #1
    ...
    public Pose getPose() {
        ...
        //return MathFunctions.rotatePose(MathFunctions.addPoses(startPose, pose), startPose.getHeading(), false);
    }
